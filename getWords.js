function parseWord(){
		var CryptoJS = CryptoJS || function(u, p) {
			var d = {},
				...
				r = l.WordArray = t.extend({
					init: function(a, c) {      //a=[910307382, 808469313, 960643909, 893530676], c=16
						a = this.words = a || [];
					...
					concat: function(a) {
						...
						this.clamp();
						if (j % 4)
							for (var k = 0; k < a; k++) c[j + k >>> 2] |= (e[k >>> 2] >>> 24 - 8 * (k % 4) & 255) << 24 - 8 * ((j + k) %
								4);
				...
				b = w.Latin1 = {
					...
					// a="6B0600CA9BCE5B24",c=16,e=[],j=0     e=[910307382, 808469313, 960643909, 893530676]
				},
				x = w.Utf8 = {
					stringify: function(a) {
						try {
				...
				stringify: function(d) {
					...
					for (var r = 0; r < p; r += 3)
						for (var w = (l[r >>> 2] >>> 24 - 8 * (r % 4) & 255) << 16 | (l[r + 1 >>> 2] >>> 24 - 8 * ((r + 1) % 4) & 255) <<
								8 | l[r + 2 >>> 2] >>> 24 - 8 * ((r + 2) % 4) & 255, v = 0; 4 > v && r + 0.75 * v < p; v++) d.push(t.charAt(
							w >>> 6 * (3 - v) & 63));
					if (l = t.charAt(64))
			...
			var u = CryptoJS,
				...
				s = p.EvpKDF = d.extend({
					...
					compute: function(d, r) {
						for (var p = this.cfg, s = p.hasher.create(), b = l.create(), u = b.words, q = p.keySize, p = p.iterations; u
							.length < q;) {
							n && s.update(n);
		...
		CryptoJS.lib.Cipher || function(u) {
			...
			q = (p.pad = {}).Pkcs7 = {
				pad: function(a, b) {
					for (var c = 4 * b, c = c - a.sigBytes % c, d = c << 24 | c << 16 | c << 8 | c, l = [], n = 0; n < c; n += 4) l
						.push(d);
					c = s.create(l, c);
					a.concat(c)
				},
					...
					_doReset: function() {
						for (var a = this._key, c = a.words, d = a.sigBytes / 4, a = 4 * ((this._nRounds = d + 6) + 1), e = this._keySchedule = [],
							...
							if (j < d) e[j] = c[j];
								...
								var k = e[j - 1];
								j % d ? 6 < d && 4 == j % d && (k = l[k >>> 24] << 24 | l[k >>> 16 & 255] << 16 | l[k >>> 8 & 255] << 8 | l[
									k & 255]) : (k = k << 8 | k >>> 24, k = l[k >>> 24] << 24 | l[k >>> 16 & 255] << 16 | l[k >>> 8 & 255] <<
									8 | l[k & 255], k ^= H[j / d | 0] << 24);
								e[j] = e[j - d] ^ k
							} c = this._invKeySchedule = [];
						for (d = 0; d < a; d++) j = a - d, k = d % 4 ? e[j] : e[j - 4], c[d] = 4 > d || 4 >= j ? k : b[l[k >>> 24]] ^
							x[l[k >>> 16 & 255]] ^ q[l[k >>>
								8 & 255]] ^ n[l[k & 255]]
					},
		...
		var _0xa12e = ['appendChild', 'fromCharCode', 'ifLSL', 'undefined', 'mPDrG', 'DWwdv', 'styleSheets', 'addRule',
			'::before', '.context_kw', '::before{content:\x20\x22', 'cssRules', 'pad', 'clamp', 'sigBytes', 'YEawH', 'yUSXm',
			'PwMPi', 'pLCFG', 'ErKUI', 'OtZki', 'prototype', 'endWith', 'test',
			...
			'enc', 'Latin1', 'parse', 'window', 'location', 'href', '146385F634C9CB00', 'decrypt', 'ZeroPadding', 'toString',
			'split', 'length', 'style', 'type', 'setAttribute', 'async', 'getElementsByTagName', 'NOyra', 'fgQCW', 'nCjZv',
		...
		CryptoJS[_0xea12('0x0')]['ZeroPadding'] = {
			'pad': function(_0x1df06f, _0x314b39) {
				...
				_0x1df06f[_0xea12('0x2')] += _0x2f7121[_0xea12('0x3')](_0x301b79, _0x2f7121[_0xea12('0x4')](_0x1df06f['sigBytes'],
					_0x301b79) || _0x301b79);
			},
			'unpad': function(_0x3994de) {
				...
				while (!_0x542e1d['byONr'](_0x542e1d['pLCFG'](_0x32bd3a[_0x542e1d[_0xea12('0x6')](_0x2a5053, 0x2)], _0x542e1d[
						'FRqnC'](0x18, _0x542e1d['DwxPM'](_0x542e1d[_0xea12('0x7')](_0x2a5053, 0x4), 0x8))), 0xff)) {
					_0x2a5053--;
				}
		...
		var keywords = CryptoJS[_0xea12('0xd')][_0xea12('0xe')][_0xea12('0xf')]('6B0600CA9BCE5B24');  //CryptoJS.enc.Latin1.parse
		console.log("data="+data);
		console.log("keywords="+ keywords);     //keywords = 36423036303043413942434535423234
		var iv = '';
		try {
		...
		console.log("words列表长度："+ words.length);
		...
		var jsLast = function() {
			...
			var _0x4f2f4a = document[_0xea12('0x1d')](_0x28d7f2[_0xea12('0x1e')])[0x0][_0xea12('0x1d')](_0x28d7f2[_0xea12(
				'0x1f')]);
			...
			while (!![]) {
				switch (_0x5420ee[_0x9ff9d9++]) {
					case '0':
						...
						continue;
					case '1':
						words[i] = String[_0xea12('0x25')](_0x423190);    //多次循环生成words列表
						//console.log("String["+_0xea12('0x25')+"]("+_0x423190+")==>"+"words["+i+"]="+String[_0xea12('0x25')](_0x423190));
						continue;
					case '2':
						...
						continue;
					case '3':
						var _0x423190 = secWords[i]; //65291
						continue;
					case '4':
					...
					case '5':
						var _0x3e8e1e = function(_0xd024e1) {
							...
							return _0x3e40d1[_0xea12('0x28')](_0xd024e1, 0x2) ? _0x3e40d1[_0xea12('0x29')](_0xd024e1, 0x2) : _0xd024e1 -
								0x4;
						};
						continue;
				}
		...
		console.log("通过函数String.fromCharCode()对secwords列表中的编码生成汉字或符号");
		console.log("words=["+words+"]");
		
//以下for循环就是将对应的汉字加载到页面中对应位置
// for (var i = 0x0; i < words[_0xea12('0x18')]; i++) {
// 	try {
// 		document[_0xea12('0x2a')][0x0][_0xea12('0x2b')]('.context_kw' + i + _0xea12('0x2c'),
// 			'content:\x20\x22' + words[i] + '\x22');
// 	} catch (_0x527f83) {
// 		document['styleSheets'][0x0]['insertRule'](_0xea12('0x2d') + i + _0xea12('0x2e') + words[i] + '\x22}', document[
// 			_0xea12('0x2a')][0x0][_0xea12('0x2f')][_0xea12('0x18')]);
// 	}
// } 
	return words;
}
